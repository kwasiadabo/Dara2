...
import { ArrowRight, Phone, BadgeCheck, Wallet, TrendingUp } from "lucide-react";
    ...
    <section className="relative overflow-hidden bg-bg-soft pt-16 pb-24 lg:pt-20 lg:pb-32">
      ...
      <Container className="relative grid grid-cols-1 items-center gap-16 lg:grid-cols-[1fr_0.9fr] lg:gap-10">
        ...
        <div className="max-w-xl">
          <motion.div custom={0} variants={heroReveal} initial="hidden" animate="visible">
          ...
          >
            Dara Micro Credit is a locally owned lending house in Achimota. We
            fund traders, business owners and salaried workers with clear
            terms, fast decisions and no hidden cost. Your wealth, our wealth.
          </motion.p>
          ...
          >
            <Button size="lg" icon={<Phone className="h-4 w-4" strokeWidth={2.5} />} asChild>
              <a href="tel:+233302446357">Call 0302 446 357</a>
            </Button>
            <Button variant="outline" size="lg" icon={<ArrowRight className="h-4 w-4" />} asChild>
          ...
          >
            <div className="flex flex-col">
              ...
              <span className="text-[13px] text-ink-soft">Customers supported</span>
            </div>
